...
我们使用爬虫工具从该网站上获得了 22~000 张图片，经过 OpenCV \footnote{\url{https://opencv.org}}识别人脸，然后裁剪、缩放到 $64\times64$大小，并用 illustration2vec~\cite{Saito2015Illustration2Vec}对数据集进行了分类，具体类别如图~\ref{fig:getchu_cls}。根据类别可以得到 34 维的条件向量，如图~\ref{fig:ill_c}~所示。
