...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|c|c|c|}
    \hline
    \multicolumn{6}{|c|}{类别向量}                      \\ \hline
    位置   & $0\sim12$ & $13\sim14$ & $15\sim17$ & $18$ & $19$ \\ \hline
    类别   & 发色 & 发长 & 发型 & 是否脸红 & 是否微笑 \\ \hline
    位置   & $0\sim12$ & $13\sim14$ & $15\sim17$ & $18$ & $19$ \\ \hline
    类别   & 是否张嘴 & 是否戴帽子 & 是否有缎带 & 是否戴眼镜 & 眼睛颜色 \\ \hline
  \end{tabular}\newline
  \caption{\kai 条件向量的构成}\label{table:ill_c}
\end{table}
